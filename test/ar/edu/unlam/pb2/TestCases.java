...
public class TestCases {
	...
	public void queSePuedaCrearUnaTarjetaDeDebito() throws NumeroDeTarjetaInvalidoException {
		...
		System.out.println(tarjetaDeDebito.getCodigoDeSeguridad());
	...
	public void queSePuedaCrearUnaTarjetaDeCredito() throws NumeroDeTarjetaInvalidoException {
		...
		Pagadora tarjetaDeCredito = new TarjetaDeCredito(NUMERO_ESPERADO, TITULAR_ESPERADO,
				CODIGO_DE_SEGURIDAD_ESPERADO, FECHA_DE_VENCIMIENTO_ESPERADO, LIMITE_COMPRA_EN_PESOS,
	...
	public void queSePuedanAgregarComerciosALaBilletera() throws CuitInvalidoException {
		...
		mataGalan.agregarComercio(new Comercio(31215654124L, "Panadería"));
	...
	@Test
	public void queSePuedanAgregarConsumidoresALaBilletera() throws DniInvalidoException, DniDuplicadoException {
		// Preparación 
		...
		System.out.println(mataGalan.getCantidadDeConsumidores());
		// Verificación
		assertEquals(CANTIDAD_DE_CONSUMIDORES_ESPERADOS, mataGalan.getCantidadDeConsumidores());
		mataGalan.traerConsumidor(27541231);
	}
	

	@Test
	public void queSePuedanAgregarDistintosMediosDePagoALaBilleteraDeUnConsumidor() throws MedioDePagoDuplicadoException, NumeroDeTarjetaInvalidoException, CBUInvalidoException, CVUInvalidoException, NoCoincideTitularException{
		// Preparación 
		...
		mataGalan.agregarMedioDePago(27541231, new TarjetaDeCredito(5423542385612354L, "Luis Gomez", 153, "10/10/2026", 100000.0, 1000.0));
...
/*	
	...
	@Test
	public void queSePuedaTransferirDeUnaCuentaAOtra() throws NumeroDeTarjetaInvalidoException, CBUInvalidoException,
			CVUInvalidoException, SaldoInsuficienteException {
		// Preparación
